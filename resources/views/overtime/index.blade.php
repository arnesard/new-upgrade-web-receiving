                ...
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('overtime.store') }}" method="POST">
                            @csrf
                            <ul class="nav nav-pills mb-4 d-flex justify-content-center gap-2 p-1 bg-light rounded-pill border"
                                id="employeeTab" role="tablist">
                                <li class="nav-item flex-fill text-center" role="presentation">
                                    <button class="nav-link active w-100 rounded-pill fw-bold" id="internal-tab"
                                        data-bs-toggle="pill" data-bs-target="#internal-employee" type="button"
                                        role="tab" aria-controls="internal-employee" aria-selected="true"
                                        style="transition: 0.3s; padding: 10px 0;">
                                        Internal
                                    </button>
                                </li>
                                <li class="nav-item flex-fill text-center" role="presentation">
                                    <button class="nav-link w-100 rounded-pill fw-bold text-secondary" id="external-tab"
                                        data-bs-toggle="pill" data-bs-target="#external-employee" type="button"
                                        role="tab" aria-controls="external-employee" aria-selected="false"
                                        style="transition: 0.3s; padding: 10px 0;">
                                        Bagian Lain
                                    </button>
                                </li>
                            ...
                            <div class="tab-content" id="employeeTabContent">
                                {{-- Tab Internal --}}
                                <div class="tab-pane fade show active" id="internal-employee" role="tabpanel"
                                        ...
                                        <div class="position-relative" id="ot-operator-search-wrapper">
                                            <div class="input-group">
                                                ...
                                                <button type="button" class="btn btn-outline-secondary px-3"
                                                    id="ot-btn-clear" title="Hapus" style="display:none;">
                                            ...
                                            <div id="ot-operator-dropdown"
                                                ...
                                                @endforeach
                                                <div id="ot-no-result" class="px-3 py-2 text-muted small"
                                                    style="display: none;">
                                                    Tidak ditemukan</div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="external-employee" role="tabpanel"
                                    ...
                                    <div class="p-3 bg-slate-50 border rounded-4 mb-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="employee_name_manual" id="ext_name"
                                                class="form-control form-control-custom bg-white"
                                                placeholder="Contoh: ardiansyah">
                                        </div>
                                        <div>
                                            <label class="form-label fw-semibold small">ID Karyawan <span
                                                    class="text-muted fw-normal">(Opsional)</span></label>
                                            <input type="text" name="employee_id_manual"
                                                class="form-control form-control-custom bg-white"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="reason" class="form-control form-control-custom" rows="4"
                                    placeholder="Pekerjaan yang di kerjakan contoh: scan..." required></textarea>
                            </div>
                                    ...
                                    <form id="filterForm" action="{{ route('overtime.index') }}" method="GET"
                                        ...
                                        <div class="col-sm-4 d-flex gap-2">
                                            ...
                                            <button type="button" id="resetFilterBtn"
                                                ...
                                                style="border-radius: 0.5rem;">
                                                <i data-lucide="refresh-cw" size="16" class="me-1"></i> Reset
                                            </button>
                                        </div>
                                    </form>
                                </div>
