                            ...
                            <div class="position-relative" id="ot-operator-wrapper">
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary px-3" id="ot-btn-clear"
                                        title="Hapus" style="display:none; border-radius: 0 0.85rem 0.85rem 0;">
                                ...
                                <div id="ot-operator-dropdown"
                                    ...
                                    @foreach ($employees as $employee)
                                        <div class="ot-operator-option px-3 py-2" style="cursor: pointer;"
                                            data-name="{{ $employee->name }}" data-id="{{ $employee->employee_id }}"
                                            data-plant="{{ $employee->plant }}">
                                            <span class="fw-bold">{{ $employee->employee_id }}</span>
                                            <span class="text-muted mx-1">—</span>
                                            <span>{{ $employee->name }}</span>
                                            <span class="badge bg-primary bg-opacity-10 text-primary ms-2"
                                                style="font-size:10px;">Plant {{ $employee->plant }}</span>
                                        </div>
                                    @endforeach
                                    <div id="ot-no-result" class="px-3 py-2 text-muted small" style="display:none;">Tidak
                                        ditemukan</div>
                                </div>
                            </div>
                        ...
                        <div id="durationPreview" class="col-12 d-none">
                            <div class="alert alert-info border-0 rounded-3 py-2 px-3 mb-0 d-flex align-items-center justify-content-between"
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="small fw-semibold">Total Lembur Dihitung: <span
                                            id="durationText">0</span>
                                        Jam</span>
                                </div>
