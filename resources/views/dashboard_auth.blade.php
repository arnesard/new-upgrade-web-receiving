                        ...
                        <div class="col-md-6 mb-4">
                            <div class="p-3 border rounded-4 bg-white h-100" style="min-height: 400px;">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <select id="filterTrend7"
                                        class="form-select form-select-sm border-0 shadow-none bg-light"
                                        style="width: auto; min-width: 130px;" onchange="filterTrend7Days(this.value)">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="p-3 border rounded-4 bg-white h-100" style="min-height: 400px;">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <select id="filterPlantGroup"
                                        class="form-select form-select-sm border-0 shadow-none bg-light"
                                        style="width: auto; min-width: 130px;" onchange="filterPlantGroup(this.value)">
                                        <option value="all">Semua Pekerjaan</option>
                                        @foreach ($allJobTypes as $jt)
                                            <option value="{{ $jt }}">{{ $jt }}</option>
                                        @endforeach
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        <div id="plantB" style="width: 100%; height: 160px;" class="border rounded-3">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div id="plantH" style="width: 100%; height: 160px;" class="border rounded-3">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div id="plantI" style="width: 100%; height: 160px;" class="border rounded-3">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div id="plantT" style="width: 100%; height: 160px;" class="border rounded-3">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @foreach (['B', 'H', 'I', 'T'] as $p)
                            <div class="col-md-6 col-lg-6">
                                <div class="p-3 border rounded-4 bg-light shadow-sm">
                                    <div class="mb-3">
                                        <h6 class="fw-bold small text-center text-uppercase text-muted border-bottom pb-2">
                                            Plant {{ $p }}</h6>
                                        <select class="form-select form-select-sm border-0 shadow-none bg-white mt-2"
                                            ...
                                            @foreach ($jobTypesPerPlant[$p] ?? [] as $job)
                                                <option value="{{ $job }}"
                                                    {{ ($selectedJobPerPlant[$p] ?? '') == $job ? 'selected' : '' }}>
                                                    {{ $job }}
                                                </option>
                                            @endforeach
                                        </select>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.addEventListener('resize', function() {
                ...
                Object.values(plantCharts).forEach(function(c) {
                    c && c.resize();
                });
                Object.values(perfCharts).forEach(function(c) {
                    c && c.resize();
                });
            });
        });
