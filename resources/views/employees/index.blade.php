...
@push('styles')
    <style>
        ...
        .card-vibrant .text-muted,
        .card-vibrant .text-slate-900 {
            color: white !important;
            opacity: 0.9;
        }
...
@section('content')
    <div class="p-3 p-md-4 max-w-7xl mx-auto">
        ...
        <div class="mb-4 d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-3">
            ...
            <button type="button" class="btn btn-sky rounded-3 px-4 py-2 d-inline-flex align-items-center gap-2 shadow-sm"
                data-bs-toggle="modal" data-bs-target="#employeeModal" onclick="openCreateEmployee()">
        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex flex-column flex-md-row gap-2">
                            <div class="input-group flex-grow-1">
                                ...
                                <input type="text" class="form-control bg-slate-50 border-start-0 ps-0 shadow-none"
                                    id="searchInput" placeholder="Cari karyawan..." onkeyup="filterTable()">
                            </div>
                            <select class="form-select bg-slate-50 shadow-none border" id="plantFilter"
                                onchange="filterTable()" style="max-width: 130px;">
                            ...
                            <select class="form-select bg-slate-50 shadow-none border" id="groupFilter"
                                onchange="filterTable()" style="max-width: 130px;">
            ...
            @if (session('success'))
                <div class="px-4 pt-3">
                    <div class="alert alert-success border-0 rounded-3 shadow-sm alert-dismissible fade show"
                        role="alert">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0" id="employeeTable">
                        <thead
                            class="bg-slate-50 text-slate-500 font-bold text-uppercase text-xs tracking-wider border-bottom text-muted">
                            <tr>
                        ...
                        <tbody class="text-sm">
                            @forelse($employees as $employee)
                                <tr class="border-bottom-slate-100 employee-row" data-plant="{{ $employee->plant }}"
                                    ...
                                    <td class="px-4 py-3 fw-semibold text-slate-900">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-sm avatar-vibrant rounded-circle d-flex align-items-center justify-content-center me-3"
                                    ...
                                    <td class="px-4 py-3">
                                        <span
                                            class="badge badge-plant-{{ $employee->plant }} rounded-pill fw-bold text-xs px-3 py-1">
                                    ...
                                    <td class="px-4 py-3">
                                        <span
                                            class="badge bg-{{ $employee->default_status == 'Team Leader' ? 'success' : ($employee->default_status == 'Driver Forklift' ? 'warning' : 'info') }} rounded-pill px-3 py-1 fw-bold text-xs border-0 shadow-sm"
                                            style="background-color: {{ $employee->default_status == 'Team Leader' ? '#10b981' : ($employee->default_status == 'Driver Forklift' ? '#f59e0b' : '#6366f1') }} !important; color: white !important;">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-custom" name="employee_id"
                                    id="emp_employee_id" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-custom" name="department"
                                    id="emp_department" required>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Position</label>
                                <input type="text" class="form-control form-control-custom" name="position"
                                    id="emp_position" required>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Status Default</label>
                                <select class="form-control form-control-custom" name="default_status"
                                    id="emp_default_status" required>
                                    <option value="">Pilih</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control form-control-custom" name="primary_job_type"
                                    id="emp_primary_job_type" required>
                                    <option value="">Pilih</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control form-control-custom" name="hire_date"
                                    id="emp_hire_date" required>
                            </div>
    ...
    <div class="modal fade" id="deleteEmployeeModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 16px; overflow: hidden;">
                ...
                <div class="modal-body">
                    <p class="mb-0">Apakah Anda yakin ingin menghapus karyawan <strong
...
@push('scripts')
    <script>
        ...
        function openEditEmployee(id, name, employeeId, plant, group, department, position, defaultStatus, primaryJobType,
            hireDate, phone, address) {
