        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="glass-card shadow-sm border-0 p-4">
                    ...
                    <form action="{{ route('input.update', ['plant' => $plant, 'id' => $data->id]) }}" method="POST"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="shift" id="shift-select"
                                        ...
                                        <option value="2" {{ $data->shift == '2' ? 'selected' : '' }}>Shift 2 (Sore)
                                        </option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="production_count"
                                        class="form-control form-control-custom border-start-0 shadow-none"
                                        value="{{ $data->production_count }}" placeholder="Masukkan total unit" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    @if ($data->photo)
                                        <img src="{{ asset($data->photo) }}" alt="Foto saat ini"
                                            style="width: 64px; height: 64px; object-fit: cover; border-radius: 10px; border: 2px solid #198754;">
                                    @endif
                                    <img id="photo-preview-edit" src="" alt="Preview"
                                        style="width: 64px; height: 64px; object-fit: cover; border-radius: 10px; border: 2px solid #0d6efd; display: none;">
                                </div>
                                @if ($data->photo)
                                    <small class="text-muted mt-1 d-block">Foto saat ini sudah ada. Upload baru untuk
                                        mengganti.</small>
                                @endif
                            </div>
